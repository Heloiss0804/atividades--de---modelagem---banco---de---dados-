...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/02/2025 às 15:53
...
(1, 160, 'Ilha que da medo na praia', 1089.00, NULL, 2),
(3, 80, 'é uma historia que não tem fim', 1089.23, NULL, 3);
...
(2, 'Ilha do Medo', '1995-05-10', 2),
(3, 'Historia sem fim', '0000-00-00', 3);
...
--
ALTER TABLE `detalhes`
  ADD CONSTRAINT `fk_detalhes_filme` FOREIGN KEY (`filme_id`) REFERENCES `filmes` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `filmes`
--
ALTER TABLE `filmes`
  ADD CONSTRAINT `fk_filmes_genero` FOREIGN KEY (`genero_id`) REFERENCES `generos` (`id`) ON DELETE CASCADE,
